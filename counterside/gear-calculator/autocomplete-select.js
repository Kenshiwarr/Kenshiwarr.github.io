...
/* 
      ...
      if (unit_hit>(enemy_EVA*1.875)) {
        CreateTooltipForAnything($('#uHtt'),'Unit has Sure fire against its target!')
      } else {
      ...
      if (unit_eva>(enemy_hit/1.875)) {
        CreateTooltipForAnything($('#uEtt'),'Unit can dodge enemy attacks!')
      } else {
